...
class Tests(unittest.TestCase):
    ...
    def test_sampson_carolina(self):
        ...
        self.assertEqual(shortest_path("https://it.wikipedia.org", "https://it.wikipedia.org/wiki/Contea_di_Sampson", "https://it.wikipedia.org/wiki/Carolina_del_Nord"),
    ...
    def test_sampson_atlantic(self):
        ...
        self.assertEqual(shortest_path("https://it.wikipedia.org", "https://it.wikipedia.org/wiki/Contea_di_Sampson", "https://it.wikipedia.org/wiki/Oceano_Atlantico"),
    ...
    def test_steven_boccaccio(self):
        ...
        self.assertEqual(shortest_path("https://it.wikipedia.org", "https://it.wikipedia.org/wiki/Episodi_di_Steven_Universe_(seconda_stagione)", "https://it.wikipedia.org/wiki/Giovanni_Boccaccio"),
